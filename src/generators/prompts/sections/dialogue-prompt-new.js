...
Keep assistant messages grouped with their human counterpart. Use [...] to truncate AI replies to keep them focused and interesting. Do not paraphrase.
...
Format each final quote as follows:
...
Separate quote blocks with an empty line.
When human and AI messages are part of the same exchange, do NOT put empty lines between them.
