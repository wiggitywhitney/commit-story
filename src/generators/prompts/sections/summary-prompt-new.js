...
const openingSentence = `Write one impactful opening sentence about the session's progress - in what way did the ball move forward? What's the overall change from this commit? Avoid weak openings like "During this development session..." or "In this commit..." or "The session began with..."`;
